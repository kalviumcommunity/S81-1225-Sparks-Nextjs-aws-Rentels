...
export default function FileUpload() {
    ...
    return (
        <div className="p-6 max-w-md mx-auto bg-white rounded-xl shadow-md space-y-4 border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Secure File Upload</h2>
          ...
          "
            ...
            {message && (
                <div
                    className={`text-sm p-3 rounded-md ${status === "error"
        ...
        `}
            ...
            {uploadedUrl && (
                <div className="mt-4 p-4 border rounded-md bg-gray-50 dark:bg-gray-900">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Uploaded File:</p>
                    {file?.type.startsWith("image/") ? (
                        <img src={uploadedUrl} alt="Uploaded" className="max-w-full h-auto rounded-md shadow-sm" />
                    ) : (
                        <a
                            href={uploadedUrl}
                            target="_blank"
